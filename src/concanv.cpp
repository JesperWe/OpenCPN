...
ConsoleCanvas::ConsoleCanvas( wxWindow *pparent ) :
        wxWindow( pparent, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxBORDER_NONE,
                _("Navigation") )
{
    pbackBrush = NULL;
    m_pParent = pparent;
